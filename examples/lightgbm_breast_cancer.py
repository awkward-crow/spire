#!/usr/bin/env python3
"""
lightgbm_breast_cancer.py
-------------------------
Trains a LightGBM binary classifier on the Wisconsin Breast Cancer dataset
using the same hyperparameters and train/test split as BreastCancer.chpl.
Reports log-loss and accuracy for direct comparison.

Usage:
    python lightgbm_breast_cancer.py [breast_cancer.csv]
"""
...
# ---- Load data -------------------------------------------------------
csvfile = sys.argv[1] if len(sys.argv) > 1 else "data/breast_cancer.csv"
...
# ---- Hyperparameters — match BreastCancer.chpl -----------------------
...
print("=== Breast Cancer Classification — LightGBM ===")
